...
sys_uname(void) {
	...
	struct utsname info;
	char *sysname	 = "\n System Name: Linux\n";
	char *nodename	 = "Node Name: 111\n";
	char *release	 = "Release: no-release\n";
	char *version	 = "Version: 0.111\n";
	char *machine	 = "Machine: RISC-V\n";
	char *domainname = "Domain Name: domain.local";
